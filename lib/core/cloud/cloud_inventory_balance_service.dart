...
class CloudInventoryBalanceService {
  ...
  Future<int> countWorkspaceBalances(String workspaceId) async {
    final rows = await _fetchCountRows(
      'workspace_inventory_balances',
      workspaceId,
    );
    return rows.length;
  }

  Future<DateTime?> latestWorkspaceBalanceUpdateAt(String workspaceId) {
    return _latestUpdatedAt('workspace_inventory_balances', workspaceId);
  }
