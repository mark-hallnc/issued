...
class CloudSupplierService {
  ...
  Future<int> countWorkspaceSuppliers(String workspaceId) async {
    final rows = await _fetchCountRows('workspace_suppliers', workspaceId);
    return rows.length;
  }

  Future<DateTime?> latestWorkspaceSupplierUpdateAt(String workspaceId) {
    return _latestUpdatedAt('workspace_suppliers', workspaceId);
  }
