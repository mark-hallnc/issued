...
class CloudCheckoutService {
  ...
  Future<int> countWorkspaceCheckouts(String workspaceId) async {
    final rows = await _fetchCountRows('workspace_checkouts', workspaceId);
    return rows.length;
  }

  Future<DateTime?> latestWorkspaceCheckoutUpdateAt(String workspaceId) {
    return _latestUpdatedAt('workspace_checkouts', workspaceId);
  }
